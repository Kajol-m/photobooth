...
// const Sticker = () => {
//   const [selectedCollection, setSelectedCollection] = useState(collection[0]); // default first
...
//             className="w-16 h-16 object-contain rounded-lg cursor-grab active:cursor-grabbing"
//             draggable
//           />
//         ))}
//       </div>
